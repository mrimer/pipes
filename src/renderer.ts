...
import { drawGranite, computeGraniteNeighbors } from './renderer/graniteRenderer';
import type { GraniteNeighbors } from './renderer/graniteRenderer';
export { drawGranite, computeGraniteNeighbors };
export type { GraniteNeighbors };
import { drawSea, seaFillColor, computeSeaNeighbors } from './renderer/seaRenderer';
import type { SeaNeighbors } from './renderer/seaRenderer';
export { drawSea, seaFillColor, computeSeaNeighbors };
export type { SeaNeighbors };
import { drawTree, drawTree2, drawTree3, drawTree4 } from './renderer/treeRenderer';
export { drawTree, drawTree2, drawTree3, drawTree4 };
