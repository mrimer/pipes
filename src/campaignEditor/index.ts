...
export class CampaignEditor {
  ...
  private _showCampaignList(): void {
    ...
    actionBar.appendChild(
      this._btn(t('editor.toolbar.import'), UI_BG, '#4a90d9', () => this._importExportFlow.importCampaign()),
    );
  ...
  private _buildCampaignDetailToolbar(campaign: CampaignDef, isOfficial: boolean): HTMLElement {
    ...
    if (!isOfficial) {
      toolbar.appendChild(this._btn(t('editor.toolbar.export'), UI_BG, '#4a90d9', () => this._importExportFlow.exportCampaign(campaign)));
      toolbar.appendChild(this._btn(t('editor.toolbar.exportTexts'), UI_BG, '#7ed321', () => this._importExportFlow.exportCampaignTexts(campaign)));
      if (DEV_CONTROLS) {
