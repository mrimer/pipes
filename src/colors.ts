...
/** Outline/shadow color for Poop tiles — default (warm dark brown). */
export const POOP_COLOR              = '#3d1c00';
/** Main fill color for Poop tiles — default (medium chocolate brown). */
export const POOP_FILL_COLOR         = '#7b3f00';
/** Highlight/sheen color for Poop tiles — default (lighter caramel). */
export const POOP_HIGHLIGHT_COLOR    = '#b5651d';
/** Outline color for Poop tiles — Fall style (deep dark brown). */
export const POOP_FALL_COLOR         = '#2a1000';
/** Main fill color for Poop tiles — Fall style (dark burnt sienna). */
export const POOP_FALL_FILL_COLOR    = '#5c2600';
/** Highlight color for Poop tiles — Fall style (warm amber). */
export const POOP_FALL_HIGHLIGHT_COLOR = '#a0522d';
/** Outline color for Poop tiles — Dark style (near-black). */
export const POOP_DARK_COLOR         = '#1a0a00';
/** Main fill color for Poop tiles — Dark style (very dark brownish). */
export const POOP_DARK_FILL_COLOR    = '#3d1c00';
/** Highlight color for Poop tiles — Dark style (dim orange-brown). */
export const POOP_DARK_HIGHLIGHT_COLOR = '#7b3f00';
/** Outline color for Poop tiles — Winter style (muted cool gray-brown). */
export const POOP_WINTER_COLOR       = '#4a3c34';
/** Main fill color for Poop tiles — Winter style (grayish brown, frozen-looking). */
export const POOP_WINTER_FILL_COLOR  = '#7a6a5e';
/** Highlight color for Poop tiles — Winter style (icy pale gray). */
export const POOP_WINTER_HIGHLIGHT_COLOR = '#b0a898';
/** Outline color for Poop tiles — Spring style (warm brown). */
export const POOP_SPRING_COLOR       = '#5c3000';
/** Main fill color for Poop tiles — Spring style (medium brown, slightly warmer). */
