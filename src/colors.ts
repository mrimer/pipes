...
export const UNCONNECTED_PIPE_BODY_COLOR = '#5f7f97';
export const PIPE_COLOR                  = UNCONNECTED_PIPE_BODY_COLOR;
...
export const FIXED_PIPE_BODY_COLOR   = UNCONNECTED_PIPE_BODY_COLOR;
export const FIXED_PIPE_COLOR        = FIXED_PIPE_BODY_COLOR;
