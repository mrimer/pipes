...
export interface PlaybackListCallbacks {
  ...
  onReplay: (record: import('./types').PlaySequenceRecord) => void;
  /** Called when Return is clicked (dismisses modal). */
  onReturn: () => void;
  /** Called with the selected record when Delete is clicked. */
  onDelete: (record: import('./types').PlaySequenceRecord) => void;
  /** Called with the selected record when Export is clicked. */
  onExport: (record: import('./types').PlaySequenceRecord) => void;
  ...
  getRecords: () => import('./types').PlaySequenceRecord[];
}
 ...
 */
function formatRecordSummary(r: import('./types').PlaySequenceRecord): string {
...
export function buildPlaybackListModal(callbacks: PlaybackListCallbacks): HTMLElement {
  ...
  let selectedRecord: import('./types').PlaySequenceRecord | null = null;
